...
📈 Output Files
File	Description
output_for_powerbi.csv	Monthly sales/profit aggregated by year/month
results.txt	Complete analysis results (KNN accuracy, sales analysis)
Console output	Visualizations (plots display during execution)
📁 Dataset
The Superstore.csv contains order data with:
